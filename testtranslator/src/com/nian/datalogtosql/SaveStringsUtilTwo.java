...
public class SaveStringsUtilTwo {
	...
	// String is table name; ArrayList is variables; each table has one list of variables
	private static HashMap<String, ArrayList<String>> factsWithVariables;

	// String is table name; ArrayList is values; each table can have many records, a list of records, each record is an array of values
	...
	// String is header, aka,  view name; ArrayList is rules; for now, each rule matches one view, one view matches a list of variables
	private static ArrayList<String> rulesToSQL;

	// String is header, aka, view name, newly created sub-table for selected records;
